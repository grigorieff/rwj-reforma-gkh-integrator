...
function rwj_reforma_gkh_integrator_activate()											//хук, срабатывает в момент активации плагина
{
...
function rwj_reforma_gkh_integrator_change_organization()
{
	...
	echo '<h2>'.date('Y-m-d H:i:s', strtotime("2015-08-31T14:41:40+03:00")).'</h2>';
	echo "<table>
			<tr>
...
function register_plugin_styles (){
	...
	wp_enqueue_style( 'rwj_reforma_gkh_integrator_style' );
}
